...
public class QASandboxEditTitlePage extends BaseHelper
{
    ...
    public QASandboxEditTitlePage(WebDriver driver) {
        this.driver = driver;
...
//        js.executeScript("arguments[0].click()",openTC);
        ...
        System.out.println("Before change:"+" "+titleField.getAttribute("value"));
        titleField.sendKeys(Keys.chord(Keys.CONTROL, "a"), Keys.DELETE);
        titleField.sendKeys("The "+"["+i+"]"+"of this use case is even/odd.");
//        js.executeScript("arguments[0].value='The [id] of this use case is even/odd.';", titleField);
        System.out.println("After change:"+" "+titleField.getAttribute("value"));
        addedTitle.name = titleField.getAttribute("value");
